...
public class EdgeOntologyFxView extends Group {
	...
	public EdgeOntologyFxView(String relation, double startx, double starty, double endx, double endy) {
		super();
	...
	public EdgeOntologyFxView(String relation, double startx, double starty, double endx, double endy, Color color) {
		super();
		this.relation = relation;
